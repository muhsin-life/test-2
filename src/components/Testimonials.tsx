      ...
      <MaxWidthWrapper>
        ...
        >
          {Testimonials.map((testimonial, i) => (
            <SwiperSlide key={`avatar-img-${i}`} className="mt-10 w-full  mb-3">
              <div className=" rounded-2xl hover:shadow-lg   bg-white border-muted border p-5 flex flex-col items-center justify-center text-center gap-3">
                ...
                <p>
                  ...
                  aliquid dolores error dignissimos veritatis, labore architecto
                  repudiandae, atque optio eum nemo consequatur iusto, est
                  possimus culpa esse deserunt quia pariatur!
                </p>
              </div>
            </SwiperSlide>
          ))}
        ...
        <div className="space-x-4 flex items-center justify-center w-full mt-4 ">
          <button className="rounded-full w-11 hover:bg-primary border border-primary hover:text-white text-primary items-center flex justify-center h-11">
            <ArrowLeft className="w-5 h-5" />
          </button>
          <button className="rounded-full w-11 bg-primary hover:border border-primary text-white hover:text-primary hover:bg-white items-center flex justify-center h-11">
